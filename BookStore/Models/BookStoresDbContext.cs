...
public partial class BookStoresDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AuthorId).HasName("PK__Author__86516BCFD63F2FE7");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__490D1AE15220C3FB");
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__Job__6E32B6A53316FA04");
        ...
        {
            entity.HasKey(e => e.PubId).HasName("PK__Publishe__2515F2229E16C4C0");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__760965CC3CB26A01");
